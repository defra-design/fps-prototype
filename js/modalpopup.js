...
function onclickRowNew(obj) {
            ...
            document.getElementById("modal-staffname").value = obj.cells[0].innerText;
            document.getElementById("modal-rate").value = obj.cells[1].innerText;
            document.getElementById("modal-hrs").value = obj.cells[2].innerText;
            document.getElementById("modal-days").value = obj.cells[3].innerText;
			  document.getElementById("modal-staffcost").value = obj.cells[4].innerText;
